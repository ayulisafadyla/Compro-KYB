                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                            ...
                            <option value="launch" {{ old('type', $event->type ?? '') == 'launch' ? 'selected' : '' }}>Events</option>
                            <option value="workshop" {{ old('type', $event->type ?? '') == 'workshop' ? 'selected' : '' }}>Penghargaan</option>
                            <option value="promo" {{ old('type', $event->type ?? '') == 'promo' ? 'selected' : '' }}>Sertifikat </option>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-2" id="preview-container">
                            @if($event->image)
                                <img id="image-preview" src="{{ asset('storage/'.$event->image) }}" class="rounded shadow-sm" style="max-width: 100%; height: 200px; object-fit: cover;">
                            @else
