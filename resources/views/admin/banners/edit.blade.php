                ...
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('subtitle') is-invalid @enderror" 
                                  id="subtitle" 
                                  name="subtitle" 
                                  rows="2">{{ old('subtitle', $banner->subtitle) }}</textarea>
                        @error('subtitle')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="3"
                                  placeholder="Teks deskripsi di bawah judul carousel...">{{ old('description', $banner->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <div class="mb-2" id="preview-container">
                            @if($banner->image)
                                <img id="image-preview" src="{{ asset('storage/' . $banner->image) }}" class="rounded shadow-sm" style="max-width: 100%; height: 150px; object-fit: cover;">
                            @else
